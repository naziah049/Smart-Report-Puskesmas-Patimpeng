        ...
        <div class="row position-relative">
          <div class="col-lg-12 chat-content show">
            <div class="chat-header border-bottom pb-2">
              <div class="d-flex justify-content-between">
                <div class="d-flex align-items-center">
                  ...
                  <div>
                    <p>{{ $konsultasi->user->name }}</p>
                    <p class="text-muted tx-13">{{ $konsultasi->user->email }}</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="chat-footer d-flex">
              <div>
                <a href="{{ route('konsultasi.showchat', $konsultasi->id) }}">
              ...
              <form class="search-form flex-grow-1 me-2" method="POST" action="{{ route('konsultasi.stafkirim') }}" id="chatForm">
                @csrf
